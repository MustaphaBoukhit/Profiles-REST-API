...
class HelloApiView(APIView):
    ...
    def get(self, request, format=None):
        ...
        an_apiview=[
            'Uses HTTP methods as function (get, post, fetch, put, delete)',
            'Is similar to a traditional Django View',
            'Gives you the most contro over your application logic',
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    "We are going to use the token authentication request to authenticate to our endpoints "
    authentication_classes = (TokenAuthentication,)
    ...
    permission_classes = (
        ...
        IsAuthenticated
        #IsAuthenticatedOrReadOnly # This will ensure that the not authenticated user cannot make any operations other than read
    )
